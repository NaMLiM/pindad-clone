        ...
        <div class="col-md-3">
            <div class="pb-5">
                ...
                <ul class="fa-ul list-aside my-3">
                    <li class="py-1"><a href="index.php?page=regulasi-keterbukaan-informasi-publik" class="active">Regulasi Keterbukaan Informasi Publik</a></li>
                    <li class="py-1"><a href="index.php?page=informasi-berkala">Informasi Berkala</a></li>
