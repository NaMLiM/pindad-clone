...
<div class="full text-center">
    ...
    <h1 class="display-5 text-light"><dt><b>REGULASI KETERBUKAAN INFORMASI PUBLIK</b></dt></h1>
</div>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Regulasi Keterbukaan Informasi Publik</li>
    </ol>
</nav>
<div class="container mt-4">
    <div class="row">
        <div class="col-md-3">
            <div class="pb-5">
                ...
                <ul class="fa-ul list-aside my-3">
                    <li class="py-1"><a href="index.php?page=regulasi_keterbukaan_informasi_publik" class="active">Regulasi Keterbukaan Informasi Publik</a></li>
                    <li class="py-1"><a href="index.php?page=informasi_berkala">Informasi Berkala</a></li>
        ...
        <div class="col-md-9 text-dark isi">
            ...
            <p>
                Anda dapat mengajukan permintaan/permohonan informasi kepada PPID PT. Pindad (Persero) melalui mekanisme dan alur permintaan/permohonan informasi dapat diakses melalui link berikut ini <a href="https://pindad.com/prosedur-permohonan-informasi">https://pindad.com/prosedur-permohonan-informasi</a>
            </p>
            ...
            <p>
                Anda dapat mengajukan keberatan terhadap layanan informasi publik kami melalui mekanisme dan alur pengajuan keberatan yang dapat diakses melalui link berikut ini <a href="https://pindad.com/prosedur-pengajuan-keberatan">https://pindad.com/prosedur-pengajuan-keberatan</a>
            </p>
