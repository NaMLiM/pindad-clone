...
<div class="full text-center">
    ...
    <h1 class="display-5 text-light"><dt><b>VIDEO</b></dt></h1>
</div>
        ...
        <div class="col-md-3">
            <div class="pb-5">
                ...
                <ul class="fa-ul list-aside my-3">
                    ...
                    <li class="py-1"><a href="index.php?page=video" class="active">Video</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9 text-dark isi">
            <p>Video Profil Perusahaan PT. Pindad (Persero)</p>
            <a href="https://youtu.be/uFq-3O_nVGA">https://youtu.be/uFq-3O_nVGA</a>
        </div>
    </div>
</div>